...
?>
<section id="<?php echo esc_html( $section_id ); ?>" class="wonder-section txt-img"
<?php
...
<div class="wrap grid<?php echo esc_html( $img_width ); ?><?php echo esc_html( $img_fill_wrap ); ?>">
	<div class="animate col<?php echo esc_html( $flip ); ?>">
		<sub>
	...
	<?php if ( $img ) : ?>
		<div class="animate col<?php echo esc_html( $img_fill ); ?>">
